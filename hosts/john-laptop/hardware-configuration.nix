...
# to /etc/nixos/configuration.nix instead.
{
  ...
  # Previously disabled i915 PSR (Panel Self Refresh) due to screen freezing issue: https://chatgpt.com/c/68f6e22a-f564-8324-b3b3-812c4a9bbfce
  # Re-enabled to allow power savings — revert if freezing returns.
  boot.kernelParams = [
    "quiet"
    "udev.log_level=3"
    #"i915.enable_psr=0"
